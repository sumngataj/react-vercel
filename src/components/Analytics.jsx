    ...
    <div className="relative flex overflow-hidden h-sreen shadow-2xl mx-auto py-8 ">
      ...
      <div className="w-full p-12">
        ...
        <p className="text-md md:text-xl text-justify leading-relaxed">
          ...
          sustainability, it is with immense pride and boundless optimism that I
        ...
        <p className="text-md md:text-xl text-justify leading-relaxed">
          ...
          a sustainable future lies in leveraging the inexhaustible energy
          sources nature provides – the sun, wind, water, and earth. From this
          belief, we have grown into a leading force in the renewable energy
          sector, committed to developing and implementing cutting-edge
          technologies that reduce carbon footprints and combat climate change
        </p>
        <br />
        <br />
