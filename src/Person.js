...
export const Person = [
  {
    ...
    pic: second,
    description: `<b>GEN WILFREDO S. BONILLA AFP (Ret)</b>
        ...
        <b>Significant Military/Civilian Schoolings:</b>
        <ul class="list-disc list-inside">
	    <li> Command and General Staff Course	- ARMY COMMAND AND STAFF COLLEGE, CANBERRA AUSTRALIA 
	    <li> Diploma of Mgmt. in Defense Studies	- UNIV OF  CANBERRA, AUSTRALIA  
	    <li> Masters of Business Administration	- PAMANTASAN NG LUNGSOD NG MAYNILA 
	    <li> BS Civil Engineering	- WESTERN MINDANAO STATE UNIVERSITY
	    <li> Sem of Financial Statement Analysis	- UNIV OF ASIA & THE PACIFIC 
	    <li> Sem of VIP Protection Operations	- INTEL SECUIRTY GROUP, PHIL ARMY 
	    <li> AFP Comptrollership Offr Basic	- AFP JOINT COMMAND AND STAFF COLLEGE
	    <li> Sem on Supply Management	-   SOUTHERN COMMAND, AFP  
	    <li> Financial Mgmt. Review Sem	- PENTAGON, USA(CONUS)
	    <li> Mine Warfare Instructor Course	-   SCHOOL OF MILITARY ENGINEERING LIVERPOOL, NSW, AUSTRALIA	
        <li> Micro Computer Literacy Course	- THE INTELLIGENCE SCHOOL, ISG, PA 
	    <li> Highest & Best Land Use Planning	- ASIAN CENTER FOR ENTREPRENEURSHIP & MGMT EDUC INC 
	    <li> Site Development & Mass Housing	- EXEC DEV ACAD OF THE PHIL 
        </ul>
        <b>Significant Key Positions held:</b>
        <ul class="list-disc list-inside">
        <li> CHIEF	- Army Internal Auditor
        <li> CHIEF	- Army Real Estate Office 
        <li> BATTALION COMDR	- 522ECB, 51EBDE, PH Army 
        <li> BATTALION COMDR	- 564ECB, 51EBDE, PH Army
        <li> EXECUTIVE OFFICER -  Office of Deputy Chief of Staff for Logistics G4, PA
        <li> GENERAL MANAGER	- Philippine Army Officer Club House, PH Army 
        <li> CHIEF ADMIN	- Office of the Commanding General, PH Army 
        <li> CHIEF ADMIN BRANCH - Program Evaluation Mgmt Review and Analysis Dev, 	Office of the Deputy Chief of Staff for Comptroller J6, General Headquarters, AFP
        <li> S4	- 103BDE, 1ID, PH Army 
        <li> CHIEF	- ENGG BR, Asst. Chief of Staff for Logistics G4, PH Army 
        <li> CHIEF	- INTL LOG BR, Chief of Staff for Logistics G4, PH Army 
        <li> CHIEF SERVICE SUPPORT BR - Chief of Staff for Logistics G4, PH Army 
        </ul> 

        <b>Company & Organizations:</b>
        <ul class="list-disc list-inside">
        <li> President, Sandigan Natin Lending Investors, Inc.
        <li> President, PMA Sandigan Class '82, 
        <li> President Holy Family Academy Alumni Assn., Inc. 
        <li> President HFA Alumni Scholarship Foundation, Inc. 
        <li> President Sandigan Golfers, Inc. 
        <li> President NCR Travelers Golfers Club, Inc. Member Free & Ancient Masons of the Philippines
        <li> Member PMA Alumni Assn. Inc. 
        <li> Member Rotary Club of Makati-Rockwell.
        </ul>
        
        <b>Award and Decoration:</b>
        <ul class="list-disc list-inside">
        <li> <b>(4)</b> Distinguished Service Star, 
        <li> <b>(1)</b> Outstanding Achievement Medal, 
        <li> <b>(1)</b> Gawad sa Kaunlaran, 
        <li> <b>(1)</b> Sagisag ng Ulirang Kawal, 
        <li> <b>(35)</b> Military Merit Medals, 
        <li> <b>(4)</b> Military Commendation Medals, 
        <li> <b>Numerous</b> badges and ribbons, letter of appreciation and commendation.
        </ul>
        `,
  },
  {
